...
<h2>SUMMARY:</h2> 
<ul>
    <li><strong>Data Science Architect</strong> with over <strong>13+ years</strong> of experience in <strong>MLOPS</strong>, <strong>Analytics</strong>, and <strong>Data Science</strong>.</li>
...
<table>
    ...
    <tr>
        ...
        <td>AI Agents, LLM, RAG, MCP, Machine Learning, Neural Networks, Deep Learning, Text Analysis, NLP, Computer Vision, ChatGPT, GAN</td>
    </tr>
    <tr>
        <td>Database</td>
    ...
    <tr>
        ...
        <td>Langchain , KERAS, TensorFlow, NLTK, Spacy, MLFlow, Airflow, OpenCV</td>
    </tr>
    <tr>
        <td>Cloud</td>
    ...
    <tr>
        <td>DevOps</td>
        <td>Docker, Kubernetes, Jenkins, Terraform, IAC, ARM, Prometheus</td>
    </tr>
    <tr>
        <td>Visualization Tools</td>
        <td>Tableau, Qlik Sense, Plotly Dash, Grafana</td>
    </tr>
    <tr>
        <td>Miscellaneous Tools</td>
        <td>Claude Code, Cursor, GitHub, SVN, Linux, Jira, Visual Studio Code, Jupyter Notebooks, Azure ML Studio, Sagemaker, Databricks</td>
    </tr>
</table>
...
<h2>Projects</h2>
<a href="({% post_url _posts/2024-03-10-Portfolio %})">Projects</a>
<br/>
<br/>
<br/>
<br/>
